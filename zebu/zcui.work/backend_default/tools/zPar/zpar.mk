...
U0/M0/F08/zrdb/ZebuDB.zdb : U0/M0/F08.$(DEFAULT_LABEL)/zrdb/ZebuDB.zdb 
	$(RMAKE) winner -C U0/M0 FX=F08 LABEL=$(DEFAULT_LABEL)
...
U0/M0/F08.$(DEFAULT_LABEL)/zrdb/ZebuDB.zdb : U0/M0/F08.src/wrapper.edf.gz U0/M0/F08.src/design_zpar.zdc 
	$(RMAKE) compil -C U0/M0 FX=F08 LABEL=$(DEFAULT_LABEL) && grep 'finished OK' U0/M0/F08.$(DEFAULT_LABEL)/xstep.cui 


clean : 
	$(RMAKE) clean -C U0/M0 FX=F00 LABEL=$(DEFAULT_LABEL)

	$(RMAKE) clean -C U0/M0 FX=F08 LABEL=$(DEFAULT_LABEL)
